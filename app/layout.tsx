...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Cahit Oben — Resmi Web Sitesi', description: 'Biyografi, diskografi, haberler ve resim çalışmaları.', url: siteUrl, siteName: 'Cahit Oben', images: [{ url: '/og.png', width: 1200, height: 630 }], locale: 'tr_TR', type: 'website' }
}
    ...
    <html lang="tr">
      <body>
        ...
        <script type="application/ld+json" suppressHydrationWarning
          dangerouslySetInnerHTML={{__html: JSON.stringify({"@context":"https://schema.org","@type":"Organization","name":"Cahit Oben","url": siteUrl,"sameAs":[
